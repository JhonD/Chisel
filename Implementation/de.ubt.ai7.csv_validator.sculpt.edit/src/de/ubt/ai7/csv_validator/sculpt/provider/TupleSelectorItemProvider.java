...
/**
 * This is the item provider adapter for a {@link de.ubt.ai7.csv_validator.sculpt.TupleSelector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TupleSelectorItemProvider 
	 ...
	 * @generated
	 */
	public TupleSelectorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SculptPackage.Literals.TUPLE_SELECTOR__REGION);
			childrenFeatures.add(SculptPackage.Literals.TUPLE_SELECTOR__SELECTORS);
		}
	...
	/**
	 * This returns TupleSelector.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TupleSelector"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_TupleSelector_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TupleSelector.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SculptPackage.Literals.TUPLE_SELECTOR__REGION,
		...
		newChildDescriptors.add
			(createChildParameter
				(SculptPackage.Literals.TUPLE_SELECTOR__SELECTORS,
				 SculptFactory.eINSTANCE.createNodeExpressionOr()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SculptPackage.Literals.TUPLE_SELECTOR__REGION ||
			childFeature == SculptPackage.Literals.TUPLE_SELECTOR__SELECTORS;
